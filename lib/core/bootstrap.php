...
include(MONK_LIB.'core/core_api.php');
...
class MONK{
    ...
    private static function init(){
        ...
        // 设置系统时区
        date_default_timezone_set(MONK::getConfig('default_timezone'));
        ...
        if($pathArray = self::$_router->parse_uri(self::$_input->pathinfo())){
            ...
            if(is_file($controllerfile)){
                ...
                if(self::$_input->is_api()) $action_subfix .= '_API';
    ...
    public static function remoteApi(){
    ...
    public static function setConfig($key, $value, $public = false){
    ...
    public static function getCache($key){
        if(isset(self::$_cache[$key]))
            ...
            throw new Exception('不存在变量为`'.$key.'`的缓存', CORE_BOOTSTRAP_EC_CACHE_NOT_EXISTS);
    } 
    
    public static function setCache($key, $value, $public = false){
